            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="barber-shop.html" class="nav-link"> Shop</a></li>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h3 class="scissors text-center">Nos produits Phares</h3>
        ...
        <div class="row hair-style">
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            <a href="Gallery1.php" class="place">
            <h2>Collonies</h2>
            <span>25€ - 85€ </span>
              <img src="assets/images/beescolony.jpg" alt="Image placeholder">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            ...
            <h2>Nos Miels</h2>
              ...
              <img src="assets/images/miel.jpg" alt="Image placeholder">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            ...
            <h2>Nos ruches</h2>
              <span>$50.00 only</span>
              <img src="assets/images/ruche1.jpg" alt="Image placeholder">
